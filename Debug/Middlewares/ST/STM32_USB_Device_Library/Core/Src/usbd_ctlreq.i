# 0 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
        ...
        case 0x03U:
          ...
          if (((uint8_t)((req->wIndex) & 0x00FFU)) <= 1U)
          {
            ...
            if (((uint8_t)idx != 0xFFU) && (idx < 1U))
            {
              ...
              if (pdev->pClass[idx]->Setup != 
# 188 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                             ((void *)0)
  ...
  switch (req->bmRequest & 0x60U)
  {
    ...
    case 0x40U:
      ...
      if (((uint8_t)idx != 0xFFU) && (idx < 1U))
      {
        ...
        if (pdev->pClass[idx]->Setup != 
# 256 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                       ((void *)0)
            ...
            case 0x03U:
              if (req->wValue == 0x00U)
              {
                ...
                if (((uint8_t)idx != 0xFFU) && (idx < 1U))
                {
                  ...
                  if (pdev->pClass[idx]->Setup != 
# 330 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                                 ((void *)0)
...
# 426 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_GetDescriptor(USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req)
{
  uint16_t len = 0U;
  uint8_t *pbuf = 
# 429 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                 ((void *)0)
...
# 486 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                                    ((void *)0)
...
# 498 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                                          ((void *)0)
...
# 510 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                                     ((void *)0)
...
# 522 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                                    ((void *)0)
...
# 534 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                                           ((void *)0)
...
# 546 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
                                                       ((void *)0)
...
# 989 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_GetString(uint8_t *desc, uint8_t *unicode, uint16_t *len)
{
  uint8_t idx = 0U;
  uint8_t *pdesc;
  ...
  if (desc == 
# 994 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
             ((void *)0)
# 994 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
                 )
  {
    return;
  }
