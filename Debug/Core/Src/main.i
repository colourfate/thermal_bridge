...
# 1 "../Core/Inc/mlx90640_adapter.h" 1
# 9 "../Core/Inc/mlx90640_adapter.h"
#define INC_MLX90640_ADAPTER_H_ 

# 1 "D:/Workspace/stm32/ThermalBridge3/Hardware/headers/MLX90640_API.h" 1
# 18 "D:/Workspace/stm32/ThermalBridge3/Hardware/headers/MLX90640_API.h"
...
int main(void)
{
 ...
 for (int i = 12; i < 13; i++) {
   for (int j = 0; j < 32; j++) {
  printf("%2.2f ", thermal_data[i * 32 + j]);
   }
      printf("\r\n");
 }
   printf("=========================================\r\n");
