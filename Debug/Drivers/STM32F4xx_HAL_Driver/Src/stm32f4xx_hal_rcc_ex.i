# 0 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
      ...
      case 0x00000000U:
        {
          ...
          if((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1UL << (22U))) == (0x1UL << (22U)))
          {
            ...
            vcoinput = (uint32_t)(25000000U / (uint32_t)(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLI2SCFGR & (0x3FUL << (0U))));
          }
          else
          {
...
# 2766 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
void HAL_RCCEx_SelectLSEMode(uint8_t Mode)
{
...
# 2858 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
