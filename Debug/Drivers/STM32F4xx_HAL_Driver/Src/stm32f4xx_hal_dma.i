...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  ...
  if(hdma == 
# 177 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
            ((void *)0)
...
HAL_StatusTypeDef HAL_DMA_DeInit(DMA_HandleTypeDef *hdma)
{
  ...
  if(hdma == 
# 314 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
            ((void *)0)
...
# 354 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                          ((void *)0)
...
# 481 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                    ((void *)0)
...
HAL_StatusTypeDef HAL_DMA_Abort(DMA_HandleTypeDef *hdma)
{
  ...
  else
  {
    ...
    if((hdma->XferHalfCpltCallback != 
# 535 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                     ((void *)0)
  ...
  if ((tmpisr & (0x00000010U << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1UL << (3U)))) != 0x00000080U)? ((hdma)->Instance->CR & (((uint32_t)(0x1UL << (3U))))) : ((hdma)->Instance->FCR & (((uint32_t)(0x1UL << (3U)))))) != RESET)
    {
      ...
      if(((hdma->Instance->CR) & (uint32_t)((0x1UL << (18U)))) != RESET)
      {
        ...
        {
          if(hdma->XferHalfCpltCallback != 
# 810 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                          ((void *)0)
...
# 819 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                            ((void *)0)
# 819 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c"
      ...
      else
      {
        ...
        if(hdma->XferHalfCpltCallback != 
# 835 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                        ((void *)0)
  ...
  if ((tmpisr & (0x00000020U << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1UL << (4U)))) != 0x00000080U)? ((hdma)->Instance->CR & (((uint32_t)(0x1UL << (4U))))) : ((hdma)->Instance->FCR & (((uint32_t)(0x1UL << (4U)))))) != RESET)
    {
      ...
      if(HAL_DMA_STATE_ABORT == hdma->State)
      {
        ...
        if((hdma->XferHalfCpltCallback != 
# 857 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                         ((void *)0)
...
# 871 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                     ((void *)0)
...
# 883 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                        ((void *)0)
...
# 892 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                      ((void *)0)
# 892 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c"
      ...
      else
      {
        ...
        if(hdma->XferCpltCallback != 
# 914 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                    ((void *)0)
...
# 949 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                 ((void *)0)
...
HAL_StatusTypeDef HAL_DMA_UnRegisterCallback(DMA_HandleTypeDef *hdma, HAL_DMA_CallbackIDTypeDef CallbackID)
{
  ...
  if(HAL_DMA_STATE_READY == hdma->State)
  {
    ...
    case HAL_DMA_XFER_CPLT_CB_ID:
      hdma->XferCpltCallback = 
# 1041 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                              ((void *)0)
# 1041 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c"
                                  ;
      break;

    case HAL_DMA_XFER_HALFCPLT_CB_ID:
      hdma->XferHalfCpltCallback = 
# 1045 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                                  ((void *)0)
...
# 1069 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c"
                                   ;
      hdma->XferAbortCallback = 
# 1070 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c" 3 4
                               ((void *)0)
# 1070 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c"
                                   ;
      break;
